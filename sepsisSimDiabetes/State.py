import numpy as np
from .utils.HelperFunctions import noisy
...
class State(object):
    ...
    def __init__(
        self, state_idx=None, idx_type="obs", diabetic_idx=None, state_categs=None
    ):
    ...
    def __eq__(self, other):
        ...
        return (
            ...
            and self.hr_state == other.hr_state
            and self.sysbp_state == other.sysbp_state
            and self.percoxyg_state == other.percoxyg_state
            and self.glucose_state == other.glucose_state
            and self.antibiotic_state == other.antibiotic_state
            and self.vaso_state == other.vaso_state
            and self.vent_state == other.vent_state
        )
    ...
    def on_treatment(self):
        ...
        """
        if self.antibiotic_state == 0 and self.vaso_state == 0 and self.vent_state == 0:
            return False
        return True
    ...
    def get_xt_ut(self):
        return np.append(self.get_xt(), self.diabetic_idx).astype(int)
